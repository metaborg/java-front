...
for project in $PROJECTS; do
  sed -i'' -e "s/$OLD_VERSION/$NEW_VERSION/g" $project/metaborg.yaml
done
...
sed -i'' -e "s/$OLD_VERSION/$NEW_VERSION/g" lang.java.eclipse.site/site.xml
sed -i'' -e "s/$OLD_VERSION/$NEW_VERSION/g" lang.java.eclipse.feature/feature.xml
sed -i'' -e "s/$OLD_VERSION/$NEW_VERSION/g" lang.java.eclipse/META-INF/MANIFEST.MF
